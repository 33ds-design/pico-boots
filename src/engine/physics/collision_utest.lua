  ...
  describe('aabb', function ()
    ...
    describe('rotated_90_cw', function ()
      it('aabb((-4, 6), (2, 3)) => aabb((-6, -4), (3, 2))"', function ()
        assert.are_same(aabb(vector(-6., -4.), vector(3., 2.)), aabb(vector(-4, 6), vector(2, 3)):rotated_90_cw())
      end)
    end)
    ...
    describe('rotate_90_cw_inplace', function ()
      it('aabb((-4, 6), (2, 3)) => aabb((-6, -4), (3, 2))"', function ()
        ...
        assert.are_same(aabb(vector(-6., -4.), vector(3., 2.)), bb)
      end)
    end)

    describe('rotated_90_ccw', function ()
      it('aabb((-4, 6), (2, 3)) => aabb((6, 4), (3, 2))"', function ()
        assert.are_same(aabb(vector(6., 4.), vector(3., 2.)), aabb(vector(-4, 6), vector(2, 3)):rotated_90_ccw())
      end)
    end)
    ...
    describe('mirror_x', function ()
      it('aabb((-4, 6), (2, 3)) => aabb((4, 6), (2, 3))"', function ()
        local bb = aabb(vector(-4, 6), vector(2, 3))
        bb:mirror_x()
        assert.are_same(aabb(vector(4., 6.), vector(2., 3.)), bb)
      end)
    end)
